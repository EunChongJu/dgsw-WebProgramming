...
public class AttachmentController {
    ...
    public AttachmentProtocol upload(@RequestPart MultipartFile srcFile) {
        String destFilename = "C:/SBEX/webclass10/upload/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy/MM/dd/")) + UUID.randomUUID().toString() + "_" + srcFile.getOriginalFilename();
        try {
    ...
    // 유저를 다운로드 하고자 하는건지 모르겠는데 이 함수는 무엇임?
